  ...
  return (
    <footer className="bg-amber-50 border-t border-amber-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
        ...
        {/* Brand Section */}
        <div>
          <h2 className="text-2xl font-bold text-yellow-800">Dearly Home</h2>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/" className="text-gray-700 hover:text-yellow-700 transition">
                Home
              </Link>
            </li>
            <li>
              <Link href="/guest-house" className="text-gray-700 hover:text-yellow-700 transition">
                Guest House
              </Link>
            </li>
            <li>
              <Link href="/cooking-class" className="text-gray-700 hover:text-yellow-700 transition">
                Cooking Class
              </Link>
            </li>
            <li>
              <Link href="/safari" className="text-gray-700 hover:text-yellow-700 transition">
                Yala Safari
              </Link>
            </li>
            <li>
              <Link href="/contact" className="text-gray-700 hover:text-yellow-700 transition">
                Contact
              </Link>
            </li>
          </ul>
